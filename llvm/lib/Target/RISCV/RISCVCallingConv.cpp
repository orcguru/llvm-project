...
bool llvm::CC_RISCV_QEMUAOT(unsigned ValNo, MVT ValVT, MVT LocVT,
                        ...
                        CCState &State) {
  static const MCPhysReg GPRList[] = {
    /* a6/rax     a7/rcx      s2/rdx      s3/rbx      s4/rsp      s5/rbp      s6/rsi      s7/rdi */
  ...
  static const MCPhysReg ArgVRs[] = {RISCV::V0, RISCV::V1,
    RISCV::V2,  RISCV::V3,  RISCV::V4, RISCV::V5, RISCV::V6, RISCV::V7,
    RISCV::V8,  RISCV::V9,  RISCV::V10, RISCV::V11, RISCV::V12, RISCV::V13,
    RISCV::V14, RISCV::V15, RISCV::V16, RISCV::V17, RISCV::V18, RISCV::V19,
    RISCV::V20, RISCV::V21, RISCV::V22, RISCV::V23, RISCV::V24, RISCV::V25,
    RISCV::V26, RISCV::V27, RISCV::V28, RISCV::V29, RISCV::V30, RISCV::V31};
...
bool llvm::RetCC_RISCV_QEMUAOT(unsigned ValNo, MVT ValVT, MVT LocVT,
                        CCValAssign::LocInfo LocInfo, ISD::ArgFlagsTy ArgFlags,
                        CCState &State) {
  static const MCPhysReg GPRList[] = {RISCV::X28, RISCV::X14};
